...
public:
  ...
  void SetDetectBlackholeEnable (bool f)
  {
    IsDetectBlackhole = f;
  }

  bool GetDetectBlackholeEnable () const
  {
    return IsDetectBlackhole;
  }

  void SetFakeAddress(Ipv4Address f) 
  {
     fakeAddress = f;
  }

  Ipv4Address GetFakeAddress() const 
  {
    return fakeAddress;
  }

  void SetMaliciousNode(Ipv4Address f) 
  {
     maliciousNode = f;
  }

  Ipv4Address GetMaliciousNode() const 
  {
