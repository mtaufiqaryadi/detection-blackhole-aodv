...
int main(int argc, char const *argv[])
{
    ...
    AnimationInterface anim ("blackholeAodv.xml");
    ...
    for (std::map<FlowId, FlowMonitor::FlowStats>::const_iterator i = stats.begin (); i != stats.end (); ++i)
        ...
        if ((t.sourceAddress=="10.1.1.2" && t.destinationAddress == "10.1.1.4"))
        {
    ...
    monitor->SerializeToXmlFile("simulationBlack1.flowmon", true, true);
