...
NS_LOG_COMPONENT_DEFINE ("BlackholeWalk");
...
int main(int argc, char const *argv[])
{
    ...
    monitor->SerializeToXmlFile("simulationBlackWalk1.flowmon", true, true);
