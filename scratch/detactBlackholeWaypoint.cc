...
NS_LOG_COMPONENT_DEFINE ("DetectWaypoint");
...
int main(int argc, char const *argv[])
{
    ...
    AnimationInterface anim ("detactblackholeAodvWaypoint.xml");
    ...
    monitor->SerializeToXmlFile("simulationDetactBlackWaypoint.flowmon", true, true);
