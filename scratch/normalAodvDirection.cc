...
NS_LOG_COMPONENT_DEFINE ("NormalDirection");
...
int main(int argc, char const *argv[])
{
    ...
    //membuat tampilan
    AnimationInterface anim ("normalAodvDirection.xml");
    ...
    monitor->SerializeToXmlFile("simulationDirection1.flowmon", true, true);
