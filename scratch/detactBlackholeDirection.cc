...
NS_LOG_COMPONENT_DEFINE ("DetectDirection");
...
int main(int argc, char const *argv[])
{
    ...
    AnimationInterface anim ("detactblackholeAodvDirection.xml");
    ...
    monitor->SerializeToXmlFile("simulationDetactBlackDirection.flowmon", true, true);
