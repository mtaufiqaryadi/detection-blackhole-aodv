...
NS_LOG_COMPONENT_DEFINE ("DetectWalk");
...
int main(int argc, char const *argv[])
{
    ...
    mobility.SetMobilityModel ("ns3::RandomWalk2dMobilityModel",
                                "Speed", StringValue ("ns3::UniformRandomVariable[Min=2|Max=60]"),
                                "Direction", StringValue ("ns3::UniformRandomVariable[Min=0.0|Max=6.28318]"),
    ...
    AnimationInterface anim ("detactblackholeAodvWalk.xml");
    ...
    monitor->SerializeToXmlFile("simulationDetactBlackWalk.flowmon", true, true);
